...
class UserRegistrationForm(forms.ModelForm):
    ...
    loginid = forms.CharField(widget=forms.TextInput(attrs={'pattern': '[a-zA-Z0-9]+'}), required=True, max_length=100)
    ...
    city = forms.CharField(widget=forms.TextInput(
        attrs={'autocomplete': 'on', 'pattern': '[A-Za-z ]+', 'title': 'Enter Characters Only '}), required=True,
        max_length=100)
